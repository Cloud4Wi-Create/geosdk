...
Endpoint to READ the [*Footfall Analysis*](/api/resources/user-created/campaign-footfall.md) Resources collection related to a single [*Campaign*](/api/resources/user-created/campaign.md).
...
* **Paginated**: YES
* **Body**: [`Page`](/api/data-models/common/page.md) of [`FootfallAnalysis`](/api/data-models/resources/user-created/campaign-footfall.md) Objects
