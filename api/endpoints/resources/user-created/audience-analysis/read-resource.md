...
Endpoint to READ a single [*Audience Analysis*](/api/resources/user-created/audience-analysis.md) Resource.
...
* **Paginated**: NO
* **Body**: [`Campaign`](/api/data-models/resources/user-created/audience-analysis.md)
