...
Endpoint to obtain [Statistics](/api/concepts/statistics.md) on [*Visit*](api/resources/platform-created/device-related/visit.md) Resources.
...
* **Body:** [`Visit-StatisticInput`](/api/data-models/r-statistic-input/visit.md)
...
A Successful response returns a [`Page`](api/general-aspects/pagination.md) of [`Visit-StatisticOutput`](/api/data-models/r-statistic-output/visit.md).

* **HTTP Status Code**: 200
* **Paginated**: YES
* **Body**: [`Page`](api/general-aspects/pagination.md#page-model)[`<Visit-StatisticOutput>`](/api/data-models/r-statistic-output/visit.md)
