...
* [**Platform-created Resources**](/api/resources/platform-created/index.md). Are automatically created by Cloud4Wi Geo Services platform. Only the READ operation is allowed. A sub-category of Platform-created Resources are:
