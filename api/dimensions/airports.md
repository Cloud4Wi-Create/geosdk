...
The *Airports* Dimension refers to the set of World's Airports
 ...
 - **Segment Data Model**: [`Airports-Segment`](/api/data-models/d-segment/airports.md)
 - **Selection/Segmentation Key**: `"airports"`
 - **Segmentation Data Model**: [`Airports-Segmentation`](/api/data-models/d-segmentation/airports.md)
...
Resulting Segments are indicated on the output side through a [`Airports-Segment`](/api/data-models/d-segment/airports.md) object formatted as in the following.
...
This Criterion can be indicated using a [`Airports-Segmentation`](/api/data-models/d-segmentation/airports.md) object formatted as in the following:
