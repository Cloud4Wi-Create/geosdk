...
A *Motion Type* Segment can represent ANY possible combination of the types of motion defined hereinafter.
 ...
 - **Resource Classes**: [*Activity*](/api/resources/platform-created/device-related/activity.md)
 ...
 - **Segmentation Data Model**: [`MotionType-Segmentation`](/api/data-models/d-segmentation/motion-type.md)
...
This Criterion can be indicated using a [`MotionType-Segmentation`](/api/data-models/d-segmentation/motion-type.md) object formatted as in the following:
