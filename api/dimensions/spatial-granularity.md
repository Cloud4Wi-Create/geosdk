...
A *Spatial Granularity* Segment can represent ANY combination of the values defined hereinafter.
 ...
 - **Resource Classes**: [*Visit*](/api/resources/platform-created/device-related/visit.md), [*Travel*](/api/resources/platform-created/device-related/travel.md)
 - **Segment Data Model**: `[String]`. An Array of `String` indicating one or more of the defined values
 - **Segment/Segmentation Key**: `"spatialGranularity"`
 - **Segmentation Data Model**: [`SpatialGranularity-Segmentation`](/api/data-models/d-segmentation/spatial-granularity.md)
...
This Criterion can be indicated using a [`SpatialGranularity-Segmentation`](/api/data-models/d-segmentation/spatial-granularity.md) object formatted as in the following:
