...
An *Administrative Area* Segment can represent ANY sub-set of all the administrative areas of the same level within a country
 ...
 - **Resource Classes**: [POI](/api/resources/platform-created/poi.md)
 - **Segment Data Model**: [`AdministrativeArea-Segment`](/api/data-models/d-segment/administrative-area.md)
 - **Segmentation Data Model**: [`AdministrativeArea-Segmentation`](/api/data-models/d-segmentation/administrative-area.md)
...
Resulting Segments are indicated on the output side through an [`AdministrativeArea-Segment`](/api/data-models/d-segment/administrative-area.md) object formatted as in the following.
...
This Criterion can be indicated using an [`AdministrativeArea-Segmentation`](/api/data-models/d-segmentation/administrative-area.md) object formatted as in the following:
