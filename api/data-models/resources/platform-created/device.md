...
------------|----------|----------------|-----------
id | `String` | ANY valid [Device ID](/service-architecture.md) | The ID assigned to Cloud4Wi platform to the specific [Device](/service-architecture.md) 
...
clientApp.id | `String` | ANY valid Client App ID | The ID assigned by Cloud4Wi platform to the specific Client App
