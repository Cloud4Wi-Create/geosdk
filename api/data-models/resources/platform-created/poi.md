...
Data Model used to represent a [*POI*](/api/resources/platform-created/poi.md) Resource.
...
administrativeAreas |[`[AdministrativeArea]`](/api/data-models/common/administrative-area.md) | An [`AdministrativeArea` object](/api/data-models/common/administrative-area.md) for each different administrative area level of the specific country | The set of administrative areas which the POI belongs to
