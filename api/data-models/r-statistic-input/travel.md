...
Name        |Type      
------------|----------
select | [`Travel-Segment`](/api/data-models/r-segment/travel.md) 
segmentBy | [`Travel-Segmentation`](/api/data-models/r-segmentation/travel.md) 
compute | [`Travel-RequestedMetrics`](/api/data-models/r-requested-metrics/travel.md) 
filter | [`Travel-AggregatedMetricsCondition`](/api/data-models/r-aggregated-metrics-condition/travel.md) 
