...
Name        |Type      
------------|----------
select | [`Activity-Segment`](/api/data-models/r-segment/activity.md) 
segmentBy | [`Activity-Segmentation`](/api/data-models/r-segmentation/activity.md) 
compute | [`Activity-RequestedMetrics`](/api/data-models/r-requested-metrics/activity.md) 
filter | [`Activity-AggregatedMetricsCondition`](/api/data-models/r-aggregated-metrics-condition/activity.md) 
