...
Name        |Type      
------------|----------
select | [`Flight-Segment`](/api/data-models/r-segment/flight.md) 
segmentBy | [`Flight-Segmentation`](/api/data-models/r-segmentation/flight.md) 
compute | [`Flight-RequestedMetrics`](/api/data-models/r-requested-metrics/flight.md) 
filter | [`Flight-AggregatedMetricsCondition`](/api/data-models/r-aggregated-metrics-condition/flight.md) 
