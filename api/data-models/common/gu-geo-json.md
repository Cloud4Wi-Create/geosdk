...
id | `String`| Any `String` with length <= 64 | A avlue of your choice. Must be unique for the set of provided Features. Necessary in case of a space segmentation using the ["ByPlaceId"](/api/dimensions/space.md#by-place-id) criterion
category | `String`| Any `String` with length <= 64 | A category of your choice. Necessary in case of a space segmentation using the ["ByPlaceCategory"](/api/dimensions/space.md#by-place-category) criterion
...
Name        |Type      | Allowed Values |Description
------------|----------|----------------|-----------
center | [`GeoPoint`](/api/data-models/common/geo-point) |     | indicates the center of the circle
