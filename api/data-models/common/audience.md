...
--------|--------|--------|--------
type   | `String` | {`"explicit"`; `"audienceBuilder"`} | Indicates whether the set of AIDs is provided as an explicit list or through the ID of an [`AudienceBuilderAnalysis`](/api/resources/user-created/audience-analysis.md)
explicit | [`explicitAudience`](#explicit-audience) | Any valid [`explicitAudience`](#explicit-audience) | The explicit list of AIDs
analysisID | `String` | Any valid analysis ID | The ID of [`AudienceBuilderAnalysis`](/api/resources/user-created/audience-analysis.md) Resource whose result has to be used as Audience
