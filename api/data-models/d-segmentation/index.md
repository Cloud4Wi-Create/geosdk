...
These Data Models are used into [`G-D-Segmentation`](/api/data-models/g-d-segmentation/index.md) Objects. 
...
- **on the input side**: to indicate the [Segmentation Criterion and Granularity](/api/concepts/statistics.md#segmentation-criteria) to use for a specific [Dimensional Selection Condition](/api/concepts/resource-selection.md#dimensional-selection-conditions) on *D*.
    - [**when accessing Statistics**](/api/endpoints/statistics/index.md):[Segmented Selection Conditions](/api/concepts/statistics.md#segmentation-operation).
- **on the output side**:
    - Never
