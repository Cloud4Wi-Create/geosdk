...
placeID | `Integer` | `1` | Indicates to segment the selected area according to the value of the field `"properites.id"` of each GuGeoJSON Feature (see [`GuGeoJSON`](/api/data-models/common/gu-geo-json.md))
placeCategory | `Integer` | `1`| Indicates to segment the selected area according to the value of the field `"properites.category"` of each GuGeoJSON Feature (see [`GuGeoJSON`](/api/data-models/common/gu-geo-json.md))
