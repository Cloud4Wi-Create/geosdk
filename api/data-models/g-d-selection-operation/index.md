...
Models used to indicate any possible combination of [Dimensional Selection Operations](/api/concepts/resource-selection.md#dimensional-selection-conditions) for a Resource Class that assumes a given [Geometry *G* on a given Dimension *D*](/api/concepts/resource-definition.md#geometries).
...
These Data Models are used into [`R-Segment`](/api/data-models/r-segment/index.md) Objects to indicate [Dimensional Selection Conditions](/api/concepts/resource-selection.md#dimensional-selection-conditions) for *R* on each Dimension *D*.
...
- **on the output side**:
    - [**when accessing Statistics**](/api/endpoints/statistics/index.md): to indicate the [Dimensional Selection Condition](/api/concepts/resource-selection.md#dimensional-selection-conditions) that has been applied for a Dimension *D*.
