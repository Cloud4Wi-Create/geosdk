...
Data model used to indicate a [`AdministrativeArea-Segment`](/api/dimension/administrative-area.md).
...
Used to indicate a [Selection Condition](/api/concepts/resource-selection.md#dimensional-selection-conditions) on the [*Administrative Area*](/api/dimensions/administrative-area.md) Dimension.
...
Depending on the specific Segmentation Criterion, different fields will be provided, as detailed [here](/api/dimensions/administrative-area.md#segmentation-criteria).
