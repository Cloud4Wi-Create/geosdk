...
Sign in to the Cloud4Wi Console using your account's credentials.
...
Now, you are ready to configure your project with the mobile apps for which you want to use Cloud4Wi Geo SDK. For each of them, add a Client App to your Project.
