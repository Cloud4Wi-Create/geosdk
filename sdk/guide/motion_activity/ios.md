...
Until the permission is not granted, Geo SDK will infer the motion activity exclusively on the basis of the information coming from the tracking, thus with a lower accuracy.
